...
extern const unsigned char music_level[];
extern const unsigned char music_game[];
extern const unsigned char music_clear[];
extern const unsigned char music_lose[];
extern const unsigned char music_gameover[];
extern const unsigned char music_welldone[];
...
const unsigned char* screenList[3*2]={
level_nam	,music_level,
gameover_nam,music_gameover,
welldone_nam,music_welldone
};
