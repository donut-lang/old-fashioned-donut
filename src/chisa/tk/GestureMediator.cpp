...
void GestureMediator::onTouchDown(const float timeMs, const unsigned int pointerIndex, const geom::Point& screenPoint)
{
...
void GestureMediator::onTouchUp(const float timeMs, const unsigned int pointerIndex, const geom::Point& screenPoint)
{
	if(!this->session_[pointerIndex]){
...
void GestureMediator::onTouchMove(const float timeMs, const unsigned int pointerIndex, const geom::Point& screenPoint)
{
	if(!this->session_[pointerIndex]){
