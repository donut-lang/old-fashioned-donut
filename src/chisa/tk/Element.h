...
public:
	...
	void loadXML(element::LayoutFactory* const factory, tinyxml2::XMLElement* const element);
...
private:
	...
	virtual void loadXMLimpl(element::LayoutFactory* const factory, tinyxml2::XMLElement* const element) = 0;
